...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.backgroundColor = @"F48430";
        self.textColor = @"f9690e";
...
- (NSDictionary *)titleAttributesHighlighted:(BOOL)highlighted
{
    ...
    return @{
        NSFontAttributeName : [UIFont fontWithName:@"Raleway-Bold" size:12.0],
...
- (NSDictionary *)subtitleAttributesHighlighted:(BOOL)highlighted
{
    ...
    paragraphStyle.lineBreakMode = NSLineBreakByTruncatingTail;
    return @{
             NSFontAttributeName : [UIFont fontWithName:@"Raleway-Medium" size:12.0],
        NSForegroundColorAttributeName : [self textColorHighlighted:highlighted],
        NSParagraphStyleAttributeName : paragraphStyle
    };
}
...
{
    return selected ? [UIColor colorWithHexString:self.backgroundColor] : [[UIColor colorWithHexString:self.backgroundColor] colorWithAlphaComponent:0.2];
}

- (UIColor *)textColorHighlighted:(BOOL)selected
{
    return selected ? [UIColor whiteColor] : [UIColor colorWithHexString:self.textColor];
}
